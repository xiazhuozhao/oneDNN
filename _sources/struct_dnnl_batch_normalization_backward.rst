.. index:: pair: struct; dnnl::batch_normalization_backward
.. _doxid-structdnnl_1_1batch__normalization__backward:
...
.. toctree::
	...
	struct_dnnl_batch_normalization_backward_primitive_desc.rst

Overview
~~~~~~~~

Batch normalization backward propagation primitive. :ref:`More...<details-structdnnl_1_1batch__normalization__backward>`
...
.. ref-code-block:: cpp
	...
	struct batch_normalization_backward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`batch_normalization_backward<doxid-structdnnl_1_1batch__normalization__backward_1a7eb3285001f64281efd93f4bcabd33ca>`();
		:ref:`batch_normalization_backward<doxid-structdnnl_1_1batch__normalization__backward_1a8bbb84e1762b1d3c70846dba72a2d2a0>`(const :ref:`primitive_desc<doxid-structdnnl_1_1batch__normalization__backward_1_1primitive__desc>`& pd);
	
		:ref:`batch_normalization_backward<doxid-structdnnl_1_1batch__normalization__backward_1afb39c80fcca35b44515ccd20bd706f39>`(
			const :ref:`primitive_desc<doxid-structdnnl_1_1batch__normalization__backward_1_1primitive__desc>`& pd,
...
.. _details-structdnnl_1_1batch__normalization__backward:
...
.. index:: pair: function; batch_normalization_backward
.. _doxid-structdnnl_1_1batch__normalization__backward_1a7eb3285001f64281efd93f4bcabd33ca:
...
.. index:: pair: function; batch_normalization_backward
.. _doxid-structdnnl_1_1batch__normalization__backward_1a8bbb84e1762b1d3c70846dba72a2d2a0:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	batch_normalization_backward(const :ref:`primitive_desc<doxid-structdnnl_1_1batch__normalization__backward_1_1primitive__desc>`& pd)
...
.. index:: pair: function; batch_normalization_backward
.. _doxid-structdnnl_1_1batch__normalization__backward_1afb39c80fcca35b44515ccd20bd706f39:
...
Constructs a batch normalization backward propagation primitive from a cache blob.
