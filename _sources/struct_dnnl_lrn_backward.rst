.. index:: pair: struct; dnnl::lrn_backward
.. _doxid-structdnnl_1_1lrn__backward:
...
.. toctree::
	...
	struct_dnnl_lrn_backward_primitive_desc.rst

Overview
~~~~~~~~

Local response normalization (LRN) backward propagation primitive. :ref:`More...<details-structdnnl_1_1lrn__backward>`
...
.. ref-code-block:: cpp
	...
	struct lrn_backward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`lrn_backward<doxid-structdnnl_1_1lrn__backward_1ab85ce3b636dc618d4337f7d66623a0d8>`();
		:ref:`lrn_backward<doxid-structdnnl_1_1lrn__backward_1a68f483e09faea1a0bc6624547d50c5d5>`(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__backward_1_1primitive__desc>`& pd);
		:ref:`lrn_backward<doxid-structdnnl_1_1lrn__backward_1a2cfb5e53aa77645732b33507d27cc8e3>`(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__backward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _details-structdnnl_1_1lrn__backward:
...
.. index:: pair: function; lrn_backward
.. _doxid-structdnnl_1_1lrn__backward_1ab85ce3b636dc618d4337f7d66623a0d8:
...
.. index:: pair: function; lrn_backward
.. _doxid-structdnnl_1_1lrn__backward_1a68f483e09faea1a0bc6624547d50c5d5:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	lrn_backward(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__backward_1_1primitive__desc>`& pd)
...
.. index:: pair: function; lrn_backward
.. _doxid-structdnnl_1_1lrn__backward_1a2cfb5e53aa77645732b33507d27cc8e3:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	lrn_backward(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__backward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
