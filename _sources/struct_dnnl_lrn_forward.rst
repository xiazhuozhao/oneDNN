.. index:: pair: struct; dnnl::lrn_forward
.. _doxid-structdnnl_1_1lrn__forward:
...
.. toctree::
	...
	struct_dnnl_lrn_forward_primitive_desc.rst

Overview
~~~~~~~~

Local response normalization (LRN) forward propagation primitive. :ref:`More...<details-structdnnl_1_1lrn__forward>`
...
.. ref-code-block:: cpp
	...
	struct lrn_forward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`lrn_forward<doxid-structdnnl_1_1lrn__forward_1a0965de329a83a356d1d0004000610451>`();
		:ref:`lrn_forward<doxid-structdnnl_1_1lrn__forward_1af08a4b4986501182caf804266af08dce>`(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__forward_1_1primitive__desc>`& pd);
		:ref:`lrn_forward<doxid-structdnnl_1_1lrn__forward_1a5cf7730307b46a04cbfa1f89f64c7e9e>`(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__forward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _details-structdnnl_1_1lrn__forward:
...
.. index:: pair: function; lrn_forward
.. _doxid-structdnnl_1_1lrn__forward_1a0965de329a83a356d1d0004000610451:
...
.. index:: pair: function; lrn_forward
.. _doxid-structdnnl_1_1lrn__forward_1af08a4b4986501182caf804266af08dce:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	lrn_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__forward_1_1primitive__desc>`& pd)
...
.. index:: pair: function; lrn_forward
.. _doxid-structdnnl_1_1lrn__forward_1a5cf7730307b46a04cbfa1f89f64c7e9e:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	lrn_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1lrn__forward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
