.. index:: pair: struct; dnnl::reduction
.. _doxid-structdnnl_1_1reduction:
...
.. toctree::
	...
	struct_dnnl_reduction_primitive_desc.rst

Overview
~~~~~~~~

Reduction. :ref:`More...<details-structdnnl_1_1reduction>`
...
.. ref-code-block:: cpp
	...
	struct reduction: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`reduction<doxid-structdnnl_1_1reduction_1a8f5ca21917318c8d1cd6b80b65df230e>`();
		:ref:`reduction<doxid-structdnnl_1_1reduction_1a4a3a374280f31de12f1bb9438e9db951>`(const :ref:`primitive_desc<doxid-structdnnl_1_1reduction_1_1primitive__desc>`& pd);
		:ref:`reduction<doxid-structdnnl_1_1reduction_1ac81a6947a08c38e1e6713c949b0cd007>`(const :ref:`primitive_desc<doxid-structdnnl_1_1reduction_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _details-structdnnl_1_1reduction:
...
.. index:: pair: function; reduction
.. _doxid-structdnnl_1_1reduction_1a8f5ca21917318c8d1cd6b80b65df230e:
...
.. index:: pair: function; reduction
.. _doxid-structdnnl_1_1reduction_1a4a3a374280f31de12f1bb9438e9db951:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	reduction(const :ref:`primitive_desc<doxid-structdnnl_1_1reduction_1_1primitive__desc>`& pd)
...
.. index:: pair: function; reduction
.. _doxid-structdnnl_1_1reduction_1ac81a6947a08c38e1e6713c949b0cd007:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	reduction(const :ref:`primitive_desc<doxid-structdnnl_1_1reduction_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
