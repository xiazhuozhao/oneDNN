.. index:: pair: struct; dnnl::lstm_forward
.. _doxid-structdnnl_1_1lstm__forward:
...
.. toctree::
	...
	struct_dnnl_lstm_forward_primitive_desc.rst

Overview
~~~~~~~~

LSTM forward propagation primitive. :ref:`More...<details-structdnnl_1_1lstm__forward>`
...
.. ref-code-block:: cpp
	...
	struct lstm_forward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`lstm_forward<doxid-structdnnl_1_1lstm__forward_1ab081cafdb894a5e1da2135501f4f1c21>`();
		:ref:`lstm_forward<doxid-structdnnl_1_1lstm__forward_1a336a0c5ca05b04f96d13f1e4a1bfbbcb>`(const :ref:`primitive_desc<doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`& pd);
		:ref:`lstm_forward<doxid-structdnnl_1_1lstm__forward_1a9377a3cb7523f83eb2e431fbced2c908>`(const :ref:`primitive_desc<doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _details-structdnnl_1_1lstm__forward:
...
.. index:: pair: function; lstm_forward
.. _doxid-structdnnl_1_1lstm__forward_1ab081cafdb894a5e1da2135501f4f1c21:
...
.. index:: pair: function; lstm_forward
.. _doxid-structdnnl_1_1lstm__forward_1a336a0c5ca05b04f96d13f1e4a1bfbbcb:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	lstm_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`& pd)
...
.. index:: pair: function; lstm_forward
.. _doxid-structdnnl_1_1lstm__forward_1a9377a3cb7523f83eb2e431fbced2c908:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	lstm_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1lstm__forward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
