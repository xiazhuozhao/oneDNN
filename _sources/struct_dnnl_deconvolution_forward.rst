.. index:: pair: struct; dnnl::deconvolution_forward
.. _doxid-structdnnl_1_1deconvolution__forward:
...
.. toctree::
	...
	struct_dnnl_deconvolution_forward_primitive_desc.rst

Overview
~~~~~~~~

Deconvolution forward propagation primitive. :ref:`More...<details-structdnnl_1_1deconvolution__forward>`
...
.. ref-code-block:: cpp
	...
	struct deconvolution_forward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`deconvolution_forward<doxid-structdnnl_1_1deconvolution__forward_1ad6ef9ec3b383a666cc8b19d5f72db647>`();
		:ref:`deconvolution_forward<doxid-structdnnl_1_1deconvolution__forward_1aa61db12ba85daa7804172ed084c8b8cc>`(const :ref:`primitive_desc<doxid-structdnnl_1_1deconvolution__forward_1_1primitive__desc>`& pd);
	
		:ref:`deconvolution_forward<doxid-structdnnl_1_1deconvolution__forward_1a3ca7a477840e1ca93e5c5599faec7dd4>`(
			const :ref:`primitive_desc<doxid-structdnnl_1_1deconvolution__forward_1_1primitive__desc>`& pd,
...
.. _details-structdnnl_1_1deconvolution__forward:
...
.. index:: pair: function; deconvolution_forward
.. _doxid-structdnnl_1_1deconvolution__forward_1ad6ef9ec3b383a666cc8b19d5f72db647:
...
.. index:: pair: function; deconvolution_forward
.. _doxid-structdnnl_1_1deconvolution__forward_1aa61db12ba85daa7804172ed084c8b8cc:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	deconvolution_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1deconvolution__forward_1_1primitive__desc>`& pd)
...
.. index:: pair: function; deconvolution_forward
.. _doxid-structdnnl_1_1deconvolution__forward_1a3ca7a477840e1ca93e5c5599faec7dd4:
...
Constructs a deconvolution forward propagation primitive from a cache blob.
