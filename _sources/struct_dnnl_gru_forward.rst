.. index:: pair: struct; dnnl::gru_forward
.. _doxid-structdnnl_1_1gru__forward:
...
.. toctree::
	...
	struct_dnnl_gru_forward_primitive_desc.rst

Overview
~~~~~~~~

GRU forward propagation primitive. :ref:`More...<details-structdnnl_1_1gru__forward>`
...
.. ref-code-block:: cpp
	...
	struct gru_forward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`gru_forward<doxid-structdnnl_1_1gru__forward_1ac3bfe27a9088c8e2a27ad88c7929de38>`();
		:ref:`gru_forward<doxid-structdnnl_1_1gru__forward_1a120dbe542bd785423ac1dea0128764aa>`(const :ref:`primitive_desc<doxid-structdnnl_1_1gru__forward_1_1primitive__desc>`& pd);
		:ref:`gru_forward<doxid-structdnnl_1_1gru__forward_1ab0ef834b5ee0cc57d0daa7c219280d3a>`(const :ref:`primitive_desc<doxid-structdnnl_1_1gru__forward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _details-structdnnl_1_1gru__forward:
...
.. index:: pair: function; gru_forward
.. _doxid-structdnnl_1_1gru__forward_1ac3bfe27a9088c8e2a27ad88c7929de38:
...
.. index:: pair: function; gru_forward
.. _doxid-structdnnl_1_1gru__forward_1a120dbe542bd785423ac1dea0128764aa:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	gru_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1gru__forward_1_1primitive__desc>`& pd)
...
.. index:: pair: function; gru_forward
.. _doxid-structdnnl_1_1gru__forward_1ab0ef834b5ee0cc57d0daa7c219280d3a:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	gru_forward(const :ref:`primitive_desc<doxid-structdnnl_1_1gru__forward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
