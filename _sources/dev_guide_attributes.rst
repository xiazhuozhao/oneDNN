...
* :ref:`Rounding mode <doxid-dev_guide_attributes_rounding_mode>` to control rounding mode upon specific argument downconversions.

* :ref:`Deterministic mode <doxid-dev_guide_attributes_deterministic>` to enforce run-to-run deterministic primitive execution.

* :ref:`Dropout <doxid-dev_guide_attributes_dropout>` to apply pseudo-random dropout to the output buffer.
