.. index:: pair: struct; dnnl::prelu_backward
.. _doxid-structdnnl_1_1prelu__backward:
...
.. toctree::
	...
	struct_dnnl_prelu_backward_primitive_desc.rst

Overview
~~~~~~~~

PReLU backward propagation primitive. :ref:`More...<details-structdnnl_1_1prelu__backward>`
...
.. ref-code-block:: cpp
	...
	struct prelu_backward: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`prelu_backward<doxid-structdnnl_1_1prelu__backward_1a52248c1da285ceb90994f58ee485ae00>`();
		:ref:`prelu_backward<doxid-structdnnl_1_1prelu__backward_1a6adcdccd5020219a1b1ba66ea2a1ba39>`(const :ref:`primitive_desc<doxid-structdnnl_1_1prelu__backward_1_1primitive__desc>`& pd);
		:ref:`prelu_backward<doxid-structdnnl_1_1prelu__backward_1aeb7331bb2e03aad3cd87f181b844774f>`(const :ref:`primitive_desc<doxid-structdnnl_1_1prelu__backward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _details-structdnnl_1_1prelu__backward:
...
.. index:: pair: function; prelu_backward
.. _doxid-structdnnl_1_1prelu__backward_1a52248c1da285ceb90994f58ee485ae00:
...
.. index:: pair: function; prelu_backward
.. _doxid-structdnnl_1_1prelu__backward_1a6adcdccd5020219a1b1ba66ea2a1ba39:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	prelu_backward(const :ref:`primitive_desc<doxid-structdnnl_1_1prelu__backward_1_1primitive__desc>`& pd)
...
.. list-table::
	...
	*
		...
		- Primitive descriptor for a prelu backward propagation primitive.

.. index:: pair: function; prelu_backward
.. _doxid-structdnnl_1_1prelu__backward_1aeb7331bb2e03aad3cd87f181b844774f:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	prelu_backward(const :ref:`primitive_desc<doxid-structdnnl_1_1prelu__backward_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
