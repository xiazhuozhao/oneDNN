.. index:: pair: example; cnn_training_f32.cpp
.. _doxid-cnn_training_f32_8cpp-example:

cnn_training_f32.cpp
====================

This C++ API example demonstrates how to build an AlexNet model training. Annotated version: :ref:`CNN f32 training example <doxid-cnn_training_f32_cpp>`
