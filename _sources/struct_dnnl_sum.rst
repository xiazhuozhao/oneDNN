.. index:: pair: struct; dnnl::sum
.. _doxid-structdnnl_1_1sum:
...
.. toctree::
	...
	struct_dnnl_sum_primitive_desc.rst

Overview
~~~~~~~~

Out-of-place summation (sum) primitive. :ref:`More...<details-structdnnl_1_1sum>`
...
.. ref-code-block:: cpp
	...
	struct sum: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`sum<doxid-structdnnl_1_1sum_1a08ab30bce8e2c28298a6926f144265b9>`();
		:ref:`sum<doxid-structdnnl_1_1sum_1a393855f591d5700e6d35e458f6910110>`(const :ref:`primitive_desc<doxid-structdnnl_1_1sum_1_1primitive__desc>`& pd);
		:ref:`sum<doxid-structdnnl_1_1sum_1aa7c43d6dd2dc63162fed2367a6ac2eae>`(const :ref:`primitive_desc<doxid-structdnnl_1_1sum_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. _doxid-structdnnl_1_1sum_1a08ab30bce8e2c28298a6926f144265b9:
...
.. index:: pair: function; sum
.. _doxid-structdnnl_1_1sum_1a393855f591d5700e6d35e458f6910110:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	sum(const :ref:`primitive_desc<doxid-structdnnl_1_1sum_1_1primitive__desc>`& pd)
...
.. index:: pair: function; sum
.. _doxid-structdnnl_1_1sum_1aa7c43d6dd2dc63162fed2367a6ac2eae:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	sum(const :ref:`primitive_desc<doxid-structdnnl_1_1sum_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
