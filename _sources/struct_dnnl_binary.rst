.. index:: pair: struct; dnnl::binary
.. _doxid-structdnnl_1_1binary:
...
.. toctree::
	...
	struct_dnnl_binary_primitive_desc.rst

Overview
~~~~~~~~

Elementwise binary operator primitive. :ref:`More...<details-structdnnl_1_1binary>`
...
.. ref-code-block:: cpp
	...
	struct binary: public :ref:`dnnl::primitive<doxid-structdnnl_1_1primitive>`
	{
		// structs
		...
		:ref:`binary<doxid-structdnnl_1_1binary_1a3e30f5d399c655ec1e5d03a1fd1b855c>`();
		:ref:`binary<doxid-structdnnl_1_1binary_1ad1c3928248051918ab44b523165e312e>`(const :ref:`primitive_desc<doxid-structdnnl_1_1binary_1_1primitive__desc>`& pd);
		:ref:`binary<doxid-structdnnl_1_1binary_1a8d470bf2ec91b74ed865f9ebc7e861e5>`(const :ref:`primitive_desc<doxid-structdnnl_1_1binary_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob);
	};
...
.. index:: pair: function; binary
.. _doxid-structdnnl_1_1binary_1a3e30f5d399c655ec1e5d03a1fd1b855c:
...
.. index:: pair: function; binary
.. _doxid-structdnnl_1_1binary_1ad1c3928248051918ab44b523165e312e:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	binary(const :ref:`primitive_desc<doxid-structdnnl_1_1binary_1_1primitive__desc>`& pd)
...
.. list-table::
	...
	*
		...
		- Primitive descriptor for an elementwise binary operation primitive.

.. index:: pair: function; binary
.. _doxid-structdnnl_1_1binary_1a8d470bf2ec91b74ed865f9ebc7e861e5:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	binary(const :ref:`primitive_desc<doxid-structdnnl_1_1binary_1_1primitive__desc>`& pd, const std::vector<uint8_t>& cache_blob)
