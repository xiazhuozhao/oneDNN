...
run_balanced_ci_tests() {
    ...
    declare -A test_costs=(
        [test_graph_unit_dnnl_sdp_decomp_cpu]=19257
        [test_benchdnn_modeC_lnorm_ci_cpu]=14902
        [test_graph_unit_dnnl_mqa_decomp_cpu]=14198
        [test_gemm_s8s8s32]=14020
        [test_benchdnn_modeC_zeropad_ci_cpu]=9827
        [test_gemm_u8s8s32]=8548
        [cpu-graph-sdpa-cpp]=7215
        [test_benchdnn_modeC_conv_ci_cpu]=5911
        [cpu-graph-gated-mlp-int4-cpp]=5736
        [test_pooling_forward]=5209
        [test_benchdnn_modeC_rnn_ci_cpu]=4483
        [test_convolution_forward_f32]=4244
        [test_convolution_eltwise_forward_f32]=3998
        [test_benchdnn_modeC_deconv_ci_cpu]=3959
        [test_convolution_backward_data_f32]=3534
        [test_gemm_f32]=2774
        [test_pooling_backward]=2733
        [test_convolution_backward_weights_f32]=2224
        [cpu-graph-gqa-training-cpp]=2115
        [test_benchdnn_modeC_concat_ci_cpu]=1586
        [test_benchdnn_modeC_bnorm_ci_cpu]=1490
        [cpu-cnn-inference-f32-cpp]=1332
        [test_benchdnn_modeC_pool_ci_cpu]=1219
        [test_benchdnn_modeC_binary_different_dt_ci_cpu]=1003
        [test_graph_unit_dnnl_convolution_cpu]=903
        [test_convolution_eltwise_forward_x8s8f32s32]=839
        [cpu-performance-profiling-cpp]=729
        [test_benchdnn_modeC_softmax_ci_cpu]=638
        [test_benchdnn_modeC_reorder_ci_cpu]=568
        [test_lrn]=549
        [test_benchdnn_modeC_lstm_ci_cpu]=493
        [cpu-cnn-training-f32-c]=409
        [test_benchdnn_modeC_binary_ci_cpu]=385
        [cpu-rnn-training-f32-cpp]=368
        [test_deconvolution]=330
        [test_benchdnn_modeC_gru_ci_cpu]=323
        [api-c]=301
        [test_graph_unit_dnnl_large_partition_cpu]=267
        [test_benchdnn_modeC_gnorm_ci_cpu]=257
        [test_benchdnn_modeC_reduction_ci_cpu]=254
        [cpu-cnn-inference-int8-cpp]=250
        [test_reorder]=249
        [test_graph_unit_dnnl_matmul_cpu]=210
        [test_benchdnn_modeC_sum_ci_cpu]=202
        [test_inner_product_backward_weights]=200
        [cpu-cnn-training-f32-cpp]=188
        [cpu-graph-sdpa-bottom-right-causal-mask-cpp]=178
        [test_benchdnn_modeC_eltwise_ci_cpu]=109
        [test_graph_unit_dnnl_convtranspose_cpu]=105
        [test_binary]=103
        [cpu-rnn-inference-f32-cpp]=100
        ...
        [test_graph_unit_dnnl_graph_cpu]=4
        ...
        [cpu-tutorials-matmul-inference-int8-matmul-cpp]=3
        [test_gemm_s8u8s32]=3
        [test_gemm_u8u8s32]=3
