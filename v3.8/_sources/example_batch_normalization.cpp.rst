.. index:: pair: example; batch_normalization.cpp
.. _doxid-batch_normalization_8cpp-example:

batch_normalization.cpp
=======================

Annotated version: :ref:`Batch Normalization Primitive Example <doxid-batch_normalization_example_cpp>`
