.. index:: pair: example; eltwise.cpp
.. _doxid-eltwise_8cpp-example:

eltwise.cpp
===========

Annotated version: :ref:`Element-Wise Primitive Example <doxid-eltwise_example_cpp>`
...
.. ref-code-block:: cpp
	...
	*******************************************************************************/
	...
	void eltwise_example(:ref:`dnnl::engine::kind <doxid-structdnnl_1_1engine_1a2635da16314dcbdb9bd9ea431316bb1a>` engine_kind) {
	    ...
	    :ref:`memory::dims <doxid-structdnnl_1_1memory_1a7d9f4b6ad8caf3969f436cd9ff27e9bb>` dst_dims = {N, IC, IH, IW};
	    ...
	    auto eltwise_pd = :ref:`eltwise_forward::primitive_desc <doxid-structdnnl_1_1eltwise__forward_1_1primitive__desc>`(:ref:`engine <doxid-structdnnl_1_1engine>`,
	            :ref:`prop_kind::forward_training <doxid-group__dnnl__api__attributes_1ggac7db48f6583aa9903e54c2a39d65438fa24775787fab8f13aa4809e1ce8f82aeb>`, :ref:`algorithm::eltwise_relu <doxid-group__dnnl__api__attributes_1gga00377dd4982333e42e8ae1d09a309640aba09bebb742494255b90b43871c01c69>`, src_md,
	            dst_md, 0.f, 0.f);
	
	    // Create the primitive.
	    auto eltwise_prim = :ref:`eltwise_forward <doxid-structdnnl_1_1eltwise__forward>`(eltwise_pd);
	
	    // Primitive arguments.
	    std::unordered_map<int, memory> eltwise_args;
	    eltwise_args.insert({:ref:`DNNL_ARG_SRC <doxid-group__dnnl__api__primitives__common_1gac37ad67b48edeb9e742af0e50b70fe09>`, src_mem});
	    eltwise_args.insert({:ref:`DNNL_ARG_DST <doxid-group__dnnl__api__primitives__common_1ga3ca217e4a06d42a0ede3c018383c388f>`, dst_mem});
