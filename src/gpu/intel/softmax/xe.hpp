...
#ifndef GPU_INTEL_SOFTMAX_XE_HPP
#define GPU_INTEL_SOFTMAX_XE_HPP
...
struct xe_softmax_fwd_t : public gpu_primitive_t {
...
struct xe_softmax_bwd_t : public gpu_primitive_t {
    using gpu_primitive_t::gpu_primitive_t;
