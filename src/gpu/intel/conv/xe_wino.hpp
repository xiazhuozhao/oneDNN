...
#ifndef GPU_INTEL_CONV_XE_WINO_HPP
#define GPU_INTEL_CONV_XE_WINO_HPP
...
struct xe_wino_convolution_fwd_t : public gpu_primitive_t {
    ...
    status_t init(impl::engine_t *engine) override {
        ...
        if (is_fused) {
            kernel_names.push_back("xe_wino_conv_fwd");
            kernel_names.push_back("xe_wino_wei_transform");
        } else if (is_nonfused_2x3) {
            kernel_names.push_back("xe_wino_conv_fwd_2x3");
            kernel_names.push_back("xe_wino_wei_transform_2x3");
            kernel_names.push_back("xe_wino_src_transform_2x3");
            kernel_names.push_back("xe_wino_dst_transform_2x3");
        } else {
