...
.. _doxid-group__dnnl__api__ukernel__brgemm_1ga8cb74d499258ac482bea0b6b650c4231:
...
.. list-table::
	...
	*
		...
		- Output packing type. Can be ``dnnl_brgemm_pack_undef`` when ukernel and transform are not supported on the target system, ``dnnl_brgemm_no_trans`` if packing is not required, and ``dnnl_pack_type_pack32`` for x64 backend, otherwise.
