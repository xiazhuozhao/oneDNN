.. index:: pair: example; deconvolution.cpp
.. _doxid-deconvolution_8cpp-example:

deconvolution.cpp
=================

Annotated version: :ref:`Deconvolution Primitive Example <doxid-deconvolution_example_cpp>`
