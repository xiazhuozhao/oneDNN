...
.. ref-code-block:: cpp
	...
	struct post_ops: public :ref:`dnnl::handle<doxid-structdnnl_1_1handle>`
	{
		...
		void :ref:`append_dw<doxid-structdnnl_1_1post__ops_1a55aad3b45a25087e0045a005384bde3a>`(
			...
			:ref:`memory::dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` kernel_size,
			:ref:`memory::dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` stride_size,
			:ref:`memory::dim<doxid-structdnnl_1_1memory_1a281426f169daa042dcf5379c8fce21a9>` padding_l_size
			);
		...
		void :ref:`append_binary<doxid-structdnnl_1_1post__ops_1a2cba08265daca7651a48453b0d906c47>`(
			:ref:`algorithm<doxid-group__dnnl__api__attributes_1ga00377dd4982333e42e8ae1d09a309640>` aalgorithm,
			const :ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>`& src1_desc,
			const :ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>`& src2_desc
			);
		...
		void :ref:`get_params_binary<doxid-structdnnl_1_1post__ops_1a79ae44b224812f7952e2ea36ac8ba42e>`(
			int index,
			:ref:`algorithm<doxid-group__dnnl__api__attributes_1ga00377dd4982333e42e8ae1d09a309640>`& aalgorithm,
			:ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>`& src1_desc,
			:ref:`memory::desc<doxid-structdnnl_1_1memory_1_1desc>`& src2_desc
			) const;
...
.. index:: pair: function; append_binary
.. _doxid-structdnnl_1_1post__ops_1a2cba08265daca7651a48453b0d906c47:
...
In the simplest case when this is the only post operation, the computations will be:
...
.. list-table::
	...
	*
		...
		- Memory descriptor of the second operand.

	*
		- src2_desc

		- Memory descriptor of the third operand. If the specified algorithm is not one that requires a ternary input, src2_desc will be ignored.
...
.. index:: pair: function; get_params_binary
.. _doxid-structdnnl_1_1post__ops_1a79ae44b224812f7952e2ea36ac8ba42e:
...
.. list-table::
	...
	*
		...
		- Output memory descriptor of the second operand.

	*
		- src2_desc

		- Output memory descriptor of the third operand.
